...
QT_MOC_LITERAL(3, 26, 12)
    ...
    "MyLabel\0Previous_Pressed\0\0Next_Pressed"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Previous_Pressed(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::Previous_Pressed)) {
                *result = 0;
            }
        }
        {
            typedef void (MyLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::Next_Pressed)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void MyLabel::Previous_Pressed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void MyLabel::Next_Pressed()
{
